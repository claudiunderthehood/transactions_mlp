...
model_name2: str = 'best_adam.pth'
model_name3: str = 'best_dropout.pth'
...
results = train_model_earlystopping_metrics(model=model, trainer=trainer, validator=validator, optimizer=optimizer, criterion=criterion, patience=3, max_epochs=1000, verbose=True, model_name=model_name2, scheduler=scheduler)
...
results = train_model_earlystopping_metrics(model=model, trainer=trainer, validator=validator, optimizer=optimizer, criterion=criterion, patience=3, max_epochs=1000, verbose=True, model_name=model_name3, scheduler=scheduler)